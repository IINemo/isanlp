...
| [UDPipe 2.5](https://ufal.mff.cuni.cz/udpipe)                                                                         | En, Ru     | En, Ru           | En, Ru          | En, Ru          | En, Ru            | -      | `isanlp.processor_udpipe` OR `docker pull tchewik/isanlp_udpipe + isanlp.processor_remote` |
...
| [spaCy](https://spacy.io/usage/models) 🔥  <br>(21 languages)                                                         | En, Ru     | En, Ru           | En, Ru          | En, Ru          | En, Ru            | En, Ru | `isanlp.processor_spacy` 
